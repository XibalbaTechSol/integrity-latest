...
- Name: smoke.spec.ts >> every route renders without a console/page error >> GET /telemetry
- Location: e2e/smoke.spec.ts:11:9

# Error details

```
Error: console/page errors on /telemetry: Failed to load resource: net::ERR_CONNECTION_REFUSED
...
- generic [active] [ref=e1]:
  - generic [ref=e3]:
    ...
    - generic [ref=e147]:
      - generic [ref=e148]:
        - heading "SDK Telemetry & Ingestion" [level=1] [ref=e150]
        - generic [ref=e151]:
      ...
      - generic [ref=e174]:
        - generic [ref=e175]:
          - generic [ref=e177]:
            - img [ref=e179]
            - generic [ref=e181]:
              - generic [ref=e182]: Oracle Link Status
              - generic [ref=e183]: No Agent Selected
          - generic [ref=e185]:
            - img [ref=e187]
            - generic [ref=e190]:
              - generic [ref=e191]: Ingested Events Count
              - generic [ref=e192]: "0"
          - generic [ref=e194]:
            - img [ref=e196]
            - generic [ref=e200]:
              - generic [ref=e201]: Last Reported Nonce
              - generic [ref=e202]: —
        - generic [ref=e203]:
          - generic [ref=e204]:
            - heading "System Load & Latency (Time Series) Seeded demo data" [level=2] [ref=e205]:
              - text: System Load & Latency (Time Series)
              - generic "This panel shows simulated content, not live oracle/chain data." [ref=e206]:
                - img [ref=e207]
                - text: Seeded demo data
            - application [ref=e212]:
              - generic [ref=e231]:
                - generic [ref=e232]:
                  - generic [ref=e234]: 10:00
                  - generic [ref=e236]: 10:05
                  - generic [ref=e238]: 10:10
                  - generic [ref=e240]: 10:15
                  - generic [ref=e242]: 10:20
                  - generic [ref=e244]: 10:25
                  - generic [ref=e246]: 10:30
                - generic [ref=e247]:
                  - generic [ref=e249]: "0"
                  - generic [ref=e251]: "55"
                  - generic [ref=e253]: "110"
                  - generic [ref=e255]: "165"
                  - generic [ref=e257]: "220"
          - generic [ref=e258]:
            - heading "Live SDK Ingestion Feed" [level=2] [ref=e259]:
              - img [ref=e260]
              - text: Live SDK Ingestion Feed
            - generic [ref=e263]:
              - generic [ref=e264]: No telemetry events found for this agent.
              - generic [ref=e265]: _ Awaiting incoming streams...
  - generic [ref=e266]: "0"
```
