...
- Name: smoke.spec.ts >> every route renders without a console/page error >> GET /chain-of-thought
- Location: e2e/smoke.spec.ts:11:9

# Error details

```
Error: console/page errors on /chain-of-thought: Failed to load resource: net::ERR_CONNECTION_REFUSED; Failed to load resource: net::ERR_CONNECTION_REFUSED
...
- generic [ref=e3]:
  ...
  - generic [ref=e147]:
    - generic [ref=e148]:
      - heading "AI Chain of Thought Traces" [level=1] [ref=e150]
      - generic [ref=e151]:
        ...
        - button "Connect Wallet" [ref=e170] [cursor=pointer]:
          ...
          - text: Connect Wallet
    - generic [ref=e174]:
      - generic [ref=e175] [cursor=pointer]: Live Stream
      - generic [ref=e176] [cursor=pointer]: Historical Traces
      - generic [ref=e177] [cursor=pointer]:
        - text: Metrics
        - generic "This panel shows simulated content, not live oracle/chain data." [ref=e178]:
          - img [ref=e179]
          - text: Seeded demo data
      - generic [ref=e181] [cursor=pointer]:
        - text: Time-Travel Debugger
        - generic "This panel shows simulated content, not live oracle/chain data." [ref=e182]:
          - img [ref=e183]
          - text: Seeded demo data
    - generic [ref=e185]:
      - generic [ref=e187]:
        - generic [ref=e188]:
          - generic [ref=e189]: "Trace:"
          - generic [ref=e190]: No traces observed yet this session — send real OTLP spans to see them here.
        - generic [ref=e191]: Select a trace above to view its real span tree.
      - generic [ref=e192]:
        - heading "Trace Details" [level=2] [ref=e193]
        - generic [ref=e194]: Select a span node from the Historical Traces tab to see its real attributes here.
```
