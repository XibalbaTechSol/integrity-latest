...
export const CinematicFooter = () => {
    return (
        <footer style={{ 
            ...
            borderTop: '1px solid hsla(var(--border-color-hsl) / 0.5)', 
            padding: '80px 40px 40px',
            color: 'var(--text-primary)'
        }}>
            <div style={{ maxWidth: '1200px', margin: '0 auto', display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', gap: '40px' }}>
                <div style={{ display: 'flex', flexDirection: 'column', gap: '16px', maxWidth: '300px', alignItems: 'center', textAlign: 'center', margin: '0 auto' }}>
                    <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '12px' }}>
                        <img 
                            src="/XibalbaSolutionsLogo.png" 
                            alt="Xibalba" 
                            style={{ height: '48px', filter: 'drop-shadow(0 0 10px rgba(212, 175, 55, 0.5))' }} 
                        />
                    </div>
            ...
            <div style={{ maxWidth: '1200px', margin: '60px auto 0', paddingTop: '24px', borderTop: '1px solid hsla(var(--border-color-hsl) / 0.5)', display: 'flex', justifyContent: 'space-between', alignItems: 'center', fontSize: '0.8rem', color: 'rgba(255,255,255,0.4)' }}>
